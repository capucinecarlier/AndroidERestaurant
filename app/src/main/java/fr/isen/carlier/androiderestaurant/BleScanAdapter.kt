...
import fr.isen.carlier.androiderestaurant.databinding.ItemBleBinding

internal class BleScanAdapter(private var itemsList: MutableList<ScanResult>, val clickListener: (BluetoothDevice) -> Unit) : RecyclerView.Adapter<BleScanAdapter.MyViewHolder>() {
