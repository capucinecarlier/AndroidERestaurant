...
import fr.isen.carlier.androiderestaurant.databinding.ActivityBleDeviceBinding
...
class BleDeviceActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.deviceState.text = getString(R.string.ble_device_disconnected)
    ...
    private fun connectionStateChange(gatt: BluetoothGatt?, newState: Int) {
        ...
        runOnUiThread{
            binding.deviceState.text = state
